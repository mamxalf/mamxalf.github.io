...
const projects = [
  {
    ...
    description:
      'One of Biggest Omnichannel in Indonesia.',
  ...
  },
  {
    name: 'Everpro',
    description:
      'Platform connected commerce #1 in Indonesia',
  ...
  },
  {
    name: 'Hi Spatial',
    description:
      'Educate about GIS Development.',
    link: { href: 'https://www.instagram.com/hi.spatial/', label: 'Hi Spatial' },
    logo: logoHiSpatial,
  },
]
